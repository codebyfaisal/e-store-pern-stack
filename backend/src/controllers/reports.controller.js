...
const getSalesReports = async (req, res) => {
  ...
  try {
    ...
    console.log("Sales report fetched successfully.", result);
...
const getInventoryReports = async (req, res) => {
  try {
    const [
      ...
      client.query(inventoryReportQueries.totalProducts[0]),
    ...
    console.log("Inventory report fetched successfully.", result);
...
const getProfitLossReport = async (req, res) => {
  try {
    ...
    console.log("Profit and Loss report fetched successfully.", result);
