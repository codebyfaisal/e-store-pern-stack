...
const SecurityPage = () => {
  ...
  const handleDeleteAccount = async () => {
    ...
    await deleteData("/api/users/profile");
  ...
  return (
    <section className="min-h-[85%] flex items-center justify-center">
      <div className="bg-base-100 p-8 rounded shadow-lg max-w-xl w-full space-y-8">
        ...
        <div className="space-y-4">
          ...
          <form onSubmit={handleChangePassword} className="space-y-4">
            ...
            >
              {updateApiLoading ? "Changing Password..." : "Change Password"}
            </button>
          </form>
        </div>
        ...
        <div className="space-y-4">
          ...
          >
            {deleteApiLoading ? "Deleting Account..." : "Delete Account"}
          </button>
        </div>
      </div>
